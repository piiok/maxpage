                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        <div class="copyright-text">
                            <p>2107© Powered by JDWEP</p>
                        </div>
                    </div> <!-- End Col -->
                    <div class="col-sm-6 text-right ">
                        <div class="social-icons">
                           <a target="_blank" href="https://web.facebook.com/repairmaxtercell1/"><i id="social-fb" class="fa fa-facebook-square fa-3x social"></i></a>
                            ...
                            <a target="_blank" href="mailto:bootsnipp@gmail.com"><i id="social-em" class="fa fa-envelope-square fa-3x social"></i></a>
                        </div>
